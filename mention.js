function(instance, context) {
    ...
    */
    ...
    function appendGroupFocus(menu) {
        console.log('append group focus fonksiyonu çalıştı');
    ...
    var listenKeys = (e) => { // after the menu opened we listen all key inputs
        console.log('listenkeys listeneri başlangıç');
        ...
        if (menu !== null) { // if the menu is already open
            var ps = menu.querySelectorAll('p[class*="' + searchText.replaceAll(' ', '') + '"]');
            var psNot = menu.querySelectorAll('p:not([class*="' + searchText.replaceAll(' ', '') + '"])');
        ...
        console.log('listenkeys listeneri bitiş');
    ...
    function openGroupFocus(userNames) {
        ...
        for (var i = 0; i < userNames.length; i++) {
            ...
            userItem.classList.add(userNames[i].replaceAll(' ', '').toLowerCase());
    ...
    document.addEventListener('keydown', function (event) {
        ...
        if (event.key === '@') {
            ...
            if (focused) {
                ...
                console.log("heyyyyyyyyyyy", wholeListUploaded);

                console.log("yooooooooooooooo", instance.data.menu);

                if (wholeListUploaded && instance.data.menu !== null) {
                    appendGroupFocus(instance.data.menu);
                    console.log('append grup focusu çalıştıran yer');
                } else {
                    openGroupFocus(userNames);
                    console.log('open gup focusu çalıştıran yer');
                }
